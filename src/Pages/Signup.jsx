  ...
  return (
    <>
      ...
      {loading ? ( // Conditionally render Loader component when loading is true
        ...
        <div className="mx-auto w-full px-4 py-16 sm:px-6 lg:px-8 min-h-screen bg-gray-950 flex flex-col items-center justify-center">
          <div className="mx-auto max-w-md text-center">
            <motion.h1
              whileInView={{ opacity: 1, y: 0 }}
              initial={{ opacity: 0, y: 20 }}
              transition={{ delay: 0, duration: 0.5 }}
              className="text-2xl font-black sm:text-3xl text-red-500">Get started today!</motion.h1>
          ...
          <form
            ...
            <motion.div
              ...
              {profilePicPreview ? (
                ...
                // <input className="cursor-pointer bg-gray-700 text-white placeholder:text-gray-300 w-24 h-24 rounded-full border border-red-200 p-4 pe-12 text-sm shadow-sm"
                //   type="file"
                //   onChange={handleProfilePicChange}
                //   accept="image/jpeg,image/png" 
                //   required/>
                <label htmlFor="file-input" className="w-24 h-24 rounded-full text-sm flex flex-row items-center justify-center bg-gray-900 hover:bg-gray-800 text-white cursor-pointer border-2 border-gray-700">
            ...
            >
              ...
              <select
                className="w-full rounded-lg border-2 border-gray-700 p-4 pe-12 text-sm shadow-sm bg-gray-900 text-white"
                value={dept}
